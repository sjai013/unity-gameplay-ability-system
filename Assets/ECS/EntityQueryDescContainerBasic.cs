...
public struct EntityQueryDescContainerBasic<T0> : IEntityQueryDescContainer {
    ...
    {
        All = new[] { ComponentType.ReadOnly<_AbilityStateComponent>(), ComponentType.ReadOnly<AbilitySourceTargetComponent>(), ComponentType.ReadOnly<T0>() },
    };
    ...
    {
        All = new[] { ComponentType.ReadWrite<_AbilityStateComponent>(), ComponentType.ReadOnly<AbilitySourceTargetComponent>(), ComponentType.ReadOnly<T0>() },
    };
