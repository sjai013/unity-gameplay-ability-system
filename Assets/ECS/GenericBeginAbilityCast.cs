...
public struct GenericBeginAbilityCast<T1> : IJobForEachWithEntity<_AbilityStateComponent, AbilitySourceTargetComponent, T1>
where T1 : struct, IComponentData, IAbilityBehaviour {
    ...
    public void Execute(Entity entity, int index, [ReadOnly] ref _AbilityStateComponent abilityStateComponent, [ReadOnly] ref AbilitySourceTargetComponent abilitySourceTarget, [ReadOnly] ref T1 ability) {
