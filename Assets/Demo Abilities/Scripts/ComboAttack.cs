...
namespace GameplayAbilitySystem.Abilities.AbilityActivations {
    [CreateAssetMenu(fileName = "Ability", menuName = "Ability System Demo/Ability Logic/Combo Attack")]
    public class ComboAttack : AbstractAbilityActivation {
        ...
        public override void ActivateAbility(AbilitySystemComponent Source, AbilitySystemComponent Target, _IAbilityBehaviour Ability) {
