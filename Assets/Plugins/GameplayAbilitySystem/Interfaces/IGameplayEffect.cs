...
namespace GameplayAbilitySystem.Interfaces
{
    ...
    public interface IGameplayEffectTags
    {
        ...
        /// </summary>
        /// <value></value>
        GameplayEffectTagContainer AssetTags { get; }

        /// <summary>
        /// <see cref="GameplayTag"/> that are given to the <see cref="IGameplayAbilitySystem"/>
        /// </summary>
        /// <value></value>
        GameplayEffectTagContainer GrantedTags { get; }
        ...
        /// </summary>
        /// <value></value>
        GameplayEffectTagContainer ApplicationTagRequirements { get; }

        /// <summary>
        /// Removes any existing <see cref="GameplayEffect"/> that have these <see cref="GameplayTag"/>.
        /// </summary>
        /// <value></value>
        GameplayEffectTagContainer RemoveGameplayEffectsWithTag { get; }
    }
